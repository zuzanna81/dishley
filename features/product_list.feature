Feature: User can see product list on the restaurant show page
  ...
  Background:
    ...
    | Double Burger | Oliver's Burger | Tasty fat burger | Main Course | 50 kr | http://www.example.com/image.jpg   |
    | Apple pie     | Oliver's Burger | Sweet pie        | Dessert     | 50 kr | http://www.example.com/image.jpg   |
